            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="locale" class="col-md-4 col-form-label text-md-end">{{ __('Language') }}</label>

                            <div class="col-md-6">
                                <select id="locale" class="form-control @error('locale') is-invalid @enderror" name="locale" required>
                                    ...
                                    <option value="it" {{ old('locale') == 'it' ? 'selected' : '' }}>Italian</option>
                                    <option value="pt" {{ old('locale') == 'pt' ? 'selected' : '' }}>Portuguese</option>
                                </select>
